...
import imgWorkCover from "../assets/image/jpg/details/details-3.jpg";
            ...
            <Row>
              <Col lg="8">
                ...
                <Text
                  ...
                  `}
                >
                  Membership Portal, Subscription Renewal Processing &amp; Event Calendar for Olde Towne Portsmouth Civic League.
                </Text>
              </Col>
            </Row>
          </Container>
          ...
          <Container>
            <Row>
              <Col lg="4" className="mb-4 mb-lg-0">
                ...
                Olde Towne Portsmouth Civic League
                </Title>
              </Col>
              <Col lg="4" className="mb-4 mb-lg-0">
